...
4. deploys the static repository to GitHub Pages.
...
4. Add a DNS `CNAME` record from `rpm.opentubex.org` to
   `opentubex.github.io`.
5. Run the **Publish RPM repository** workflow once with a release tag.
